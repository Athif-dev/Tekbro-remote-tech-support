...
export default function Terms() {
  return (
    ...
    <p>This website is operated by Tekbro. Throughout the site, the terms “we”, “us” and “our” refer to Tekbro. Tekbro offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
...
Our store is hosted on Shopify Inc. They provide us with the online e-commerce platform that allows us to sell our products and services to you
    ...
    <div className='content'>
        ...
        <div className='content'>
        <h2>Modifications to the service & prices</h2>
        ...
        <div className='content'>
        <h2>User comments, feedback & other submissions</h2>
        ...
        <div className='content'>
        <h2> Errors, innaccuracies & omissions errors</h2>
        ...
        <li>To collect or track the personal information of others; (i) to spam, phish, pharm, pretext, spider, crawl, or scrape</li>
        <li>Or any obscene or immoral purpose</li>
        ...
        <div className='content'>
        <h2>Disclaimer of warranties; Limitation of liabilty</h2>
        ...
        <p>You agree to indemnify, defend and hold harmless Tekbro and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
        </div>
        ...
        <div className='content'>
        <h2>ENTIRE AGREEMENT Entire Agreement</h2>
        ...
        <div className='content'>
        <h2>Governing law</h2>
        <p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of #100, Woodcock Road, Ooty, TN, 643006, India.</p>
        </div>
        ...
        <h2>Contact information</h2>
           <p>Questions about the Terms of Service should be sent to us at support@tekbro.in.</p>
        </div>
    </div>
    <Footer />
