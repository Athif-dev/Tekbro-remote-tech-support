...
import '../components/css/Refund_Policy.css';
...
function Refund_Policy() {
  return (
    ...
    <h1>Return and Refund Policy</h1>
        ...
        <p>Thank you for shopping at Tekbro website and Tekbro app.</p>
    ...
    <h2>Definitions</h2>
        ...
        <ul>
        <li>
        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Tekbro</p>
        </li>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Mouse Point INC, #100, Woodcock Road, ooty.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Tekbro, accessible from <a href="https://mousepoint.co.in/tekbro" rel="external nofollow noopener" target="_blank">https://mousepoint.co.in/tekbro</a></p>
        </li>
        <li>
    ...
    <h2>Your Order Cancellation Rights</h2>
        ...
        <ul>
        <li>By email: ameen@mousepoint.co.in</li>
        </ul>
